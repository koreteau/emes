    ...
    return (
        <div className="grid grid-cols-2 h-screen">
            <div className="bg-primary flex flex-col items-center justify-center">
                ...
                <Typography className="text-xs" color="white">Enterprise Performance Management Solution</Typography>
            </div>
            <div className="flex flex-col items-center justify-center">
                <div className="rounded-lg shadow-2xl p-5 w-96 flex flex-col items-center justify-center gap-4">
                    <Typography className="text-3xl" color="secondary">H.U.B</Typography>
                    <hr />
